...
class Archer(override val innerGens: Array<Double>, override val type: Int): Character(innerGens, CharacterType.ARCHER, type) {

    companion object {
        fun random(type: Int): Archer =
                Archer(
    ...
    override fun getDescendant(): Character {
        return Archer(innerGens.copyOf(), type)
    }
